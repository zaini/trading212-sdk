...
| --- | --- | --- | --- |
| TypeScript / JavaScript | `npm install @azaini/t212-sdk` | `import { Trading212Client } from "@azaini/t212-sdk"` | [sdks/typescript](sdks/typescript/README.md) |
...
```ts
import { Trading212Client, Trading212Environment } from "@azaini/t212-sdk";
