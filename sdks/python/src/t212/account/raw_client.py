...
class RawAccountClient:
    ...
    def get_summary(self, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[AccountSummary]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    AccountSummary,
                    parse_obj_as(
                        type_=AccountSummary,  # type: ignore
...
class AsyncRawAccountClient:
    ...
    ) -> AsyncHttpResponse[AccountSummary]:
        """
        Provides a breakdown of your account's cash and investment metrics,
        including available funds, invested capital, and total account value.
